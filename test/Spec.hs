...
main = hspec $ do
    ...
    describe "d2s" $ do
        ...
        it "regression" $ do
            ...
            d2s 1.9430376160308388e16   `shouldBe` "1.9430376160308388e16"
            d2s (-6.9741824662760956e19)`shouldBe` "-6.9741824662760956e19"
            d2s 4.3816050601147837e18   `shouldBe` "4.3816050601147837e18"
